...
public class CateringFacility {
    ...
    private final ObservableMap<LocalDate, SecretKey> secretKeyMap;
    private final ObservableMap<LocalDate, byte[]> pseudonymMap;

    public CateringFacility(String CF, String location) {
        this.CF = CF;
        this.location = location;
        this.secretKeyMap = FXCollections.observableMap(new HashMap<>());
        this.pseudonymMap = FXCollections.observableMap(new HashMap<>());
    }
    ...
    public ObservableMap<LocalDate, SecretKey> getSecretKeyMap() {
        return secretKeyMap;
    }

    public ObservableMap<LocalDate, byte[]> getPseudonymMap() {
        return pseudonymMap;
    }
}
